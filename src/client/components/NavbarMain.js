...
import logo from '../images/devad.svg';

import Mlogo from '../images/makeanav.svg';
        ...
        return (
            <nav className="navbar navbar-expand-sm  w-100 " style={{ position: "relative", top: "0", zIndex: "3", padding: "0" }} >
                <div className="d-flex w-100" >
                    <div className="align-self-center">
                        <div className="navbar-brand nav-des " > <img src={logo} alt="wish logo" width="100%" height="100%" /> device advice</div>
                    </div>
                    <div className=" w-100" >
